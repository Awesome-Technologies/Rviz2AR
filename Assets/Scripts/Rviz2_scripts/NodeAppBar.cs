...
namespace HoloToolkit.Unity.UX
{
    ...
    /// </summary>
    public class NodeAppBar : InteractionReceiver
    {
        ...
        private NodeBoundingBoxRig boundingRig;

        /// <summary>
        /// a reference to the boundingBoxRig that the appbar turns on and off
        /// </summary>
        public NodeBoundingBoxRig BoundingRig
        {
        ...
        private void CreateButton(ButtonTemplate template, ButtonIconProfile customIconProfile)
        {
            ...
            NodeAppBarButton mtb = newButton.AddComponent<NodeAppBarButton>();
