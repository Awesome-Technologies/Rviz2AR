...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class NodeHandDraggable : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        /// <summary>
        ...
        //-- Das Skript, das unsere Node an die Toolbox anhängt oder entfernt.
        private NodeToParentMapper nodeToParent;
        ...
        public void StartDragging(Vector3 initialDraggingPosition)
        {
            ...
            //--sobald ich eine Node greife entferne ich die Node aus der Toolbox, wenn sie in ihr drinnen ist
        ...
        {
            //-- in der FUnktion könnte ich noch eine Abfrage machen, ob die Toolbox erkann wird.
            //-- dabei könnte ich die Nodes skalieren und von der Position und Rotation an die Toolbox anpassen, sobald ich sie anschaue
            //-- Merke: sobald ich eine Node dragge sollte ich das Followen der Toolbox ausschalten, das das sonst ziemlich nerfen könnte
