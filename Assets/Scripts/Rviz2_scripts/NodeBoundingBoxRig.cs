...
namespace HoloToolkit.Unity.UX
{
    ...
    /// </summary>
    public class NodeBoundingBoxRig : MonoBehaviour
    {
        [Header("Flattening")]
        [SerializeField]
        ...
        [SerializeField]
        [Tooltip("NodeAppBar prefab.")]
        private NodeAppBar appBarPrefab = null;

        private BoundingBox boxInstance;

        private GameObject objectToBound;

        private NodeAppBar appBarInstance;
        ...
        private NodeBoundingBoxGizmoHandle[] rigScaleGizmoHandles;

        private NodeBoundingBoxGizmoHandle[] rigRotateGizmoHandles;
        ...
        private void UpdateCornerHandles()
        {
            ...
            if (cornerHandles == null)
            {
                ...
                rigScaleGizmoHandles = new NodeBoundingBoxGizmoHandle[handleCentroids.Count];
                for (int i = 0; i < cornerHandles.Length; ++i)
                {
                    ...
                    rigScaleGizmoHandles[i] = cornerHandles[i].AddComponent<NodeBoundingBoxGizmoHandle>();
        ...
        private void UpdateRotateHandles()
        {
            ...
            if (rotateHandles == null)
            {
                ...
                rigRotateGizmoHandles = new NodeBoundingBoxGizmoHandle[12];
                for (int i = 0; i < rotateHandles.Length; ++i)
                {
                    ...
                    rigRotateGizmoHandles[i] = rotateHandles[i].AddComponent<NodeBoundingBoxGizmoHandle>();
